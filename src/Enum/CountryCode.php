...
enum CountryCode: string implements EnumValueObject
{
    ...
    case Colombia = 'COL';
    case Comoros = 'COM';
    case CongoBrazzaville = 'COG';
    case CongoKinshasa = 'COD';
    ...
    case SouthGeorgiaAndTheSouthSandwichIslands = 'SGS';
    case SouthSudan = 'SSD';
    case Spain = 'ESP';
    case SriLanka = 'LKA';
    case Sudan = 'SDN';
    ...
    case USMinorOutlyingIslands = 'UMI';
    case Uruguay = 'URY';
    case Uzbekistan = 'UZB';
    case Vanuatu = 'VUT';
    case Venezuela = 'VEN';
    case VietNam = 'VNM';
    case VirginIslands = 'VIR';
